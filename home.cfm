...
<cfset local.resultExcelQuery = Duplicate(session.testExcel)>
		...
		<cfloop query="session.testExcel">
			...
			<cfdump  var="#session.testExcel.email#">
				...
				<cfif QueryRecordCount(local.checkEmailQuery)>
					<cfquery name="local.updateContactQuery">
						UPDATE
							contactDetails
						SET
							title = <cfqueryparam value = "#session.testExcel.title#" cfsqltype = "cf_sql_varchar">,
							firstName = <cfqueryparam value = "#session.testExcel.firstname#" cfsqltype = "cf_sql_varchar">,
							lastName = <cfqueryparam value = "#session.testExcel.lastname#" cfsqltype = "cf_sql_varchar">,
							gender = <cfqueryparam value = "#session.testExcel.gender#" cfsqltype = "cf_sql_varchar">,
							dob = <cfqueryparam value = "#session.testExcel.dob#" cfsqltype = "cf_sql_date">,
							address = <cfqueryparam value = "#session.testExcel.address#" cfsqltype = "cf_sql_varchar">,
							street = <cfqueryparam value = "#session.testExcel.street#" cfsqltype = "cf_sql_varchar">,
							district = <cfqueryparam value = "#session.testExcel.district#" cfsqltype = "cf_sql_varchar">,
							STATE = <cfqueryparam value = "#session.testExcel.state#" cfsqltype = "cf_sql_varchar">,
							country = <cfqueryparam value = "#session.testExcel.country#" cfsqltype = "cf_sql_varchar">,
							pincode = <cfqueryparam value = "#session.testExcel.pincode#" cfsqltype = "cf_sql_varchar">,
							email = <cfqueryparam value = "#session.testExcel.email#" cfsqltype = "cf_sql_varchar">,
							phone = <cfqueryparam value = "#session.testExcel.phone#" cfsqltype = "cf_sql_varchar">,
					...
					<cfquery name="local.deleteRoleQuery"> <!--- Make this soft delete --->
						DELETE FROM
							contactRoles
						WHERE
							contactId = <cfqueryparam value="#local.checkEmailQuery.contactId#" cfsqltype="cf_sql_integer">
					...
					<cfif len(trim(session.testExcel.roles))>
						<cfquery name="local.addRolesQuery">
							...
							VALUES
							<cfloop list="#session.testExcel.roles#" index="local.i" item="local.roleName">
								(
								...
								<cfif local.i LT listLen(session.testExcel.roles)>,</cfif>
							</cfloop>
						</cfquery>
					</cfif>
				...
				<cfelse>
					<cfquery name="local.insertContactQuery" result="local.insertContactResult">
						...
						VALUES (
							...
							<cfqueryparam value = "#session.testExcel.pincode#" cfsqltype = "cf_sql_char">,
							<cfqueryparam value = "#session.testExcel.email#" cfsqltype = "cf_sql_varchar">,
							<cfqueryparam value = "#session.testExcel.phone#" cfsqltype = "cf_sql_varchar">,
